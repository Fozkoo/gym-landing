...
function Contact() {
  ...
  return (
    <>
        ...
        <div className="container-slider flex h-[550px]  max-lg:justify-center ">
                ...
                <div className="container-img  w-6/12 flex justify-center items-center max-lg:w-11/12">
                    ...
                    <div className="text-form w-10/12">
                        ...
                        <div className="form flex flex-col gap-6 mt-5">
                            <input type="text" placeholder='Nombre' className='w-4/6 p-3 outline-none max-lg:w-11/12'/> 
                            <input type="email" placeholder='Email' className='w-4/6 p-3 outline-none max-lg:w-11/12'/>
                            <input type="number" placeholder='Numero' className='w-4/6 p-3 outline-none max-lg:w-11/12'/>
                        </div>

                        <div className="boton w-4/6 p-3 mt-5 flex justify-center max-lg:w-11/12">
